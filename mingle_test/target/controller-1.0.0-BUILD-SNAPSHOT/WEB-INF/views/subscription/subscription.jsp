...
<script>
    ...
    window.portoneStoreId = '${initParam.portoneStoreId}';
    window.portoneChannelKey = '${initParam.portoneChannelKey}';
...
<script src="${pageContext.request.contextPath}/resources/js/subscription/subscription.js?v=20260921-3"></script>
